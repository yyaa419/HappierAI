...
const thoughts = [
  ...
  { 
    id: "4", 
    title: "Delegation Benefits",
    positiveText: "Even if I delegate, I will still gain some control.",
    negativeText: "Delegating might seem like losing control, but it can actually enhance my ability to manage effectively.",
  },
];
...
const IrrationalThoughtsHistory = ({ navigation }) => {
            ...
            header: () => (
              <SafeAreaView style={styles.headerContainer}>
                <View style={styles.header}>
                  ...
                  <Text style={styles.title}> all irrational thoughts</Text>
                </View>
              </SafeAreaView>
            ),
          }}
...
export default IrrationalThoughtsHistory;
